...
const navigation = [
  ...
  { name: 'Learn the Core', href: '#', current: false },
  { name: 'Build a Project', href: '#', current: false },
  { name: 'Opensource Contributions', href: '#', current: false },
];
                ...
                !user?.displayName && (
                  <>
                    ...
                    >
                      ...
                      <p className="pb-2">
                        Before you start going through the course, we adivse
                        that you need to complete your profile.
                      </p>
                      <Link
                        href="/profile"
                    ...
                    <SelectCourse user={user} setCourse={setCourse} />
                  </>
                )
              ) : (
                <Course course={course} reset={reset} />
              )}
            </div>
          </main>
        </div>
